...
class ConverterTest(unittest.TestCase):
    ...
    def test_name_table(self):
        expected = [
            ...
            (0x409, 2, u'Regular'),
            (0x409, 3, u'2.000;NONE;WapuroMincho-Regular'),
            (0x409, 4, u'Wapuro Mincho Regular'),
            (0x409, 5, u'Version 2.000'),
    ...
    def test_h2x_name_table(self):
        expected = [
            ...
            (0x409, 2, u'Regular'),
            (0x409, 3, u'2.000;NONE;WapuroMincho-YokoBaikaku'),
    ...
    def test_v2x_name_table(self):
        expected = [
            ...
            (0x409, 2, u'Regular'),
            (0x409, 3, u'2.000;NONE;WapuroMincho-TateBaikaku'),
